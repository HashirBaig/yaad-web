      ...
      <header className="sticky top-0 z-50 px-4 py-2 shadow-md bg-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <div className="hover:bg-gray-100 transition duration-150 ease-out flex items-center rounded-full p-1">
              <FireIcon className="h-5 w-5 text-amber-500" />
              <span className="text-lg font-semibold text-gray-500">{streak?.noOfDays || 0}</span>
            </div>
